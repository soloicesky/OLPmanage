...
VALUES (40, '机构用户', 'organ/List', 'T', null, 22, 2);
#新增机构账户余额
INSERT INTO paygateway.T_SYS_MENU (id, name, url, level, icon_class, parent_id, sort)
VALUES (41, '机构账户余额', 'organ/balance', 'T', null, 22, 3);
#机构账户明细
INSERT INTO paygateway.T_SYS_MENU (id, name, url, level, icon_class, parent_id, sort)
VALUES (42, '机构账户明细', 'organ/detail', 'T', null, 22, 4);
#机构账户提现
INSERT INTO paygateway.T_SYS_MENU (id, name, url, level, icon_class, parent_id, sort)
VALUES (43, '机构账户提现', 'organ/withdraw', 'T', null, 22, 5);
...
ALTER TABLE organ COMMENT = '机构账户余额信息表';
