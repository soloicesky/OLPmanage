...
<div class="page-container">
                    ...
                    <div class="col-sm-3">
                        <span class="select-box" >
                            <select class="select" name="tradeType" size="1">
                                <option value="00" selected>交易类型</option>
                                   <option value="10">微信</option>
                                   <option value="11">微信公众号</option>
                                   <option value="20">支付宝</option>
                                <option value="21">支付宝服务窗</option>
                            </select>
                        </span>
                    </div>
                    <div class="col-sm-3" >
    ...
    <div class="Huialert Huialert-success" style="text-align: right">
        <span class="label label-default radius" style="margin-right: 20px;">微信：<strong
                id="total_10">0</strong>元(共 <font id='count_10'>0</font>笔)</span>
        <span class="label label-default radius" style="margin-right: 20px;">微信公众号：<strong
                id="total_11">0</strong>元(共 <font id='count_11'>0</font>笔)</span>
        <span class="label label-default radius" style="margin-right: 20px;">支付宝：<strong
                id="total_20">0</strong>元(共 <font id='count_20'>0</font>笔)</span>
        <span class="label label-default radius" style="margin-right: 20px;">支付宝服务窗：<strong id="total_21">0</strong>元(共 <font
                id='count_21'>0</font>笔)</span>
    </div>
...
//            {"data": "settleStatus"}
        ...
        "ajax": {
            ...
            "dataSrc": function (data) {
                $("#total_10").html(data.map['10']);
                $("#total_11").html(data.map['11']);
                $("#total_20").html(data.map['20']);
                $("#total_21").html(data.map['21']);
                $("#count_10").html(data.map['count_10']);
                $("#count_11").html(data.map['count_11']);
                $("#count_20").html(data.map['count_20'])
                $("#count_21").html(data.map['count_21']);
