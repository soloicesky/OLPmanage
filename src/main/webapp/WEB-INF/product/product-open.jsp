                ...
                <c:forEach var="p" items="${ProductList}">
                    ...
                    <dl class="permission-list" id="dl${p.id}">
                        ...
                        <dd>
                            <div class="row cl">
                                <div class="col-sm-3">
                                    <input type="text" class="input-text" placeholder="T0固定手续费" name="fixT0Fee"  value="">
                                </div>
                                <div class="col-sm-3">
...
<script type="text/javascript">
    $(function () {
        ...
        //注册输入框值发生改变时的事件
        $("dd input").bind('input propertychange', function() {
            var parentEle  = $(this).parents('dl');
            var dtInput = $(parentEle).find("dt input");
            console.log(dtInput.attr("data"));
            dtInput.removeAttr("disabled")
        });
    })
