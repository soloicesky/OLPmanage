...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 路由管理
    <span class="c-gray en">&gt;</span> 产品路由
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
        <a href="javascript:;" onclick="admin_add('添加产品通道路由','${basePath}/product/route/addpage','800','500')" class="btn btn-primary radius">
        <i class="Hui-iconfont">&#xe600;</i> 添加产品通道路由
        </a>
        </span>
    </div>
                ...
                "ajax": {
                    ...
                    "dataSrc": function (data) {
                        ...
                        for (var i = 0; i < dataArr.length; i++) {
                            ...
                            replaceHtml = replaceHtml.replace("{ID}",dataArr[i].id);
...
<script type="text/html" id="doMore">
    <a title="修改通道" href="javascript:;" onclick="admin_edit('修改通道','${basePath}/product/route/editpage','{ID}','800','500')" class="ml-5" style="text-decoration:none">
        <i class="Hui-iconfont">&#xe6df;</i>
    </a>
</script>
<script type="text/javascript">
