...
<script type="text/javascript">
    ...
    var t = $(".table-bg").dataTable({
                ...
                "ajax": {
                    "url": "${basePath}/platform/subCommConfig/listdata",
                    "type": "POST",
                    "data": function (d) {
                    ...
                    "dataSrc": function (data) {
                        ...
                        for (var i = 0; i < dataArr.length; i++) {
                            ...
                            replaceHtml = replaceHtml.replace("{agentNo}",dataArr[i].channelNo);
...
<script type="text/html" id="doMore">
    <a title="查看详情" href="javascript:;" onclick="admin_edit('查看详情','${basePath}/platform/subCommConfig/toUpdate','{agentNo}','1000','500')" class="ml-5" style="text-decoration:none">
        <i class="Hui-iconfont">&#xe6df;</i>
    </a>
</script>
</body>
