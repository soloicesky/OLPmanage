...
<div class="page-container">
    <div class="text-c"> 日期范围：
        ...
        <input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'datemin\')}',maxDate:'%y-%M-%d' })" id="datemax"
               class="input-text Wdate" style="width:120px;">
        <input type="text" class="input-text" style="width:250px" placeholder="输入渠道商名称" id="nickName" name="nickName">
                ...
                "ajax": {
                    ...
                    "dataSrc": function (data) {
                        ...
                        for (var i = 0; i < dataArr.length; i++) {
                            var itemHtml = html;
                            itemHtml = itemHtml.replace("{ID}",dataArr[i].channelNo);
...
<script type="text/html" id="doMore">
    <a title="产品开通" href="javascript:;" onclick="admin_edit('产品开通','${basePath}/product/open','{ID}','800','500')" class="ml-5" style="text-decoration:none">
        <i class="Hui-iconfont">&#xe6df;</i>
    </a>
</script>
<script type="text/javascript">
    ...
    function admin_edit(title, url, id, w, h) {
        layer_show(title, url+"?channelNo="+id, w, h);
    }
