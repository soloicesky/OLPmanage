...
public class EncryptUtil {
    ...
    public static String md5Digest(String src) {
		...
		try {
			...
			throw new IllegalArgumentException("md5 error");
		}
    ...
    public static String base64Encoder(String src) throws Exception {
        return Base64Utils.encodeToString(src.getBytes(UTF8));
    }
    ...
    public static String base64Decoder(String dest) throws Exception {
        return new String( Base64Utils.decodeFromString(dest), UTF8);
    }
