 ...
 */
@Controller
@RequestMapping("quick/trade")
public class QuickOrderController extends BaseLog<QuickOrderController> {
    ...
    public ModelAndView listPage(){
        return new ModelAndView("order/quickorder-list");
    }
